...
let createNote = function() {
	...
	notes.data.push(value); // push adiciona no final do array
...
//assim que o conteudo for carregado eu executo o que estiver aqui dentro
document.addEventListener('DOMContentLoaded',function (event){
	...
	formAddNotes.addEventListener('submit',function (e){ //ouvinte de eventos
		e.preventDefault();
		// console.log('enviou');
		createNote();
	});
...
document.addEventListener('click',function (e){
	...
	//se o pai do elemento que clico é igual a notesTag
